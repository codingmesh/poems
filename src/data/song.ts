...
export const SONG_POETS: Poet[] = [
    ...
    relations: [
      {
        ...
        extra: [
          { title: '狱中寄子由二首 其一', author: '苏轼', lines: ['圣主如天万物春，', '小臣愚暗自亡身。', '百年未满先偿债，', '十口无归更累人。', '是处青山可埋骨，', '他年夜雨独伤神。', '与君世世为兄弟，', '更结来生未了因。'] },
        ],
      },
      {
        targetName: '王弗', type: '寄',
        poems: [
      ...
      {
        targetName: '密州', type: '提及',
        poems: [
          { title: '江城子·密州出猎', author: '苏轼', lines: ['老夫聊发少年狂，', '左牵黄，', '右擎苍。', '锦帽貂裘，', '千骑卷平冈。', '为报倾城随太守，', '亲射虎，', '看孙郎。', '酒酣胸胆尚开张，', '鬓微霜，', '又何妨。', '持节云中，', '何日遣冯唐。', '会挽雕弓如满月，', '西北望，', '射天狼。'] },
        ],
        extra: [
          { title: '望江南·超然台作', author: '苏轼', lines: ['春未老，', '风细柳斜斜。', '试上超然台上看，', '半壕春水一城花。', '烟雨暗千家。', '寒食后，', '酒醒却咨嗟。', '休对故人思故国，', '且将新火试新茶。', '诗酒趁年华。'] },
        ],
      },
      {
        targetName: '陈襄', type: '提及',
        poems: [
      ...
      {
        targetName: '文同', type: '酬和',
        poems: [
          { title: '和文与可洋川园池三十首 湖桥', author: '苏轼', lines: ['朱栏画柱照湖明，', '白葛乌纱曳履行。', '桥下龟鱼晚无数，', '识君拄杖过桥声。'] },
          { title: '和文与可洋川园池三十首 横湖', author: '苏轼', lines: ['贪看翠盖拥红妆，', '不觉湖边一夜霜。', '卷却天机云锦段，', '从教匹练写秋光。'] },
        ],
        extra: [
          { title: '和文与可洋川园池三十首 书轩', author: '苏轼', lines: ['雨昏石砚寒云色，', '风动牙签乱叶声。', '庭下已生书带草，', '使君疑是郑康成。'] },
        ],
      },
      {
        targetName: '王安石', type: '酬和',
        poems: [
          { title: '次荆公韵四绝 其三', author: '苏轼', lines: ['骑驴渺渺入荒陂，', '想见先生未病时。', '劝我试求三亩宅，', '从公已觉十年迟。'] },
        ],
      },
      {
        targetName: '刘景文', type: '寄',
        poems: [
          { title: '赠刘景文', author: '苏轼', lines: ['荷尽已无擎雨盖，', '菊残犹有傲霜枝。', '一年好景君须记，', '最是橙黄橘绿时。'] },
        ],
      },
      {
        targetName: '惠崇', type: '提及',
        poems: [
  ...
  },
  {
    ...
    relations: [
      ...
      },
      {
        ...
        extra: [
          { title: '明妃曲二首 其二', author: '王安石', lines: ['明妃初嫁与胡儿，', '毡车百两皆胡姬。', '含情欲语独无处，', '传与琵琶心自知。', '黄金杆拨春风手，', '弹看飞鸿劝胡酒。', '汉宫侍女暗垂泪，', '沙上行人却回首。', '汉恩自浅胡恩深，', '人生乐在相知心。', '可怜青冢已芜没，', '尚有哀弦留至今。'] },
        ],
      },
      {
        targetName: '王令', type: '寄',
        poems: [
          { title: '思王逢原三首 其二', author: '王安石', lines: ['蓬蒿今日想纷披，', '冢上秋风又一吹。', '妙质不为平世得，', '微言惟有故人知。', '庐山南堕当书案，', '湓水东来入酒卮。', '陈迹可怜随手尽，', '欲欢无复似当时。'] },
        ],
      },
      {
        targetName: '梅花', type: '提及',
        poems: [
    ...
    relations: [
      {
        ...
        extra: [
          { title: '关山月', author: '陆游', lines: ['和戎诏下十五年，', '将军不战空临边。', '朱门沉沉按歌舞，', '厩马肥死弓断弦。', '戍楼刁斗催落月，', '三十从军今白发。', '笛里谁知壮士心，', '沙头空照征人骨。', '中原干戈古亦闻，', '岂有逆胡传子孙。', '遗民忍死望恢复，', '几处今宵垂泪痕。'] },
        ],
      },
      {
        targetName: '子聿', type: '寄',
        poems: [
  ...
  },
  {
    ...
    relations: [
      ...
      {
        targetName: '春日', type: '提及',
        poems: [
          { title: '春日', author: '朱熹', lines: ['胜日寻芳泗水滨，', '无边光景一时新。', '等闲识得东风面，', '万紫千红总是春。'] },
        ],
      },
      {
        targetName: '劝学', type: '提及',
        poems: [
          { title: '偶成', author: '朱熹', lines: ['少年易老学难成，', '一寸光阴不可轻。', '未觉池塘春草梦，', '阶前梧叶已秋声。'] },
        ],
      },
      {
        targetName: '水口', type: '提及',
        poems: [
  ...
  },
  {
    ...
    relations: [
      ...
      },
      {
        targetName: '朱熹', type: '寄',
        poems: [
          { title: '寄题朱元晦武夷精舍十二咏 其一 精舍', author: '杨万里', lines: ['忆我南溪北，', '千岩万壑亭。', '妒渠紫阳叟，', '诧杀一峰青。'] },
          { title: '寄题朱元晦武夷精舍十二咏 其二 仁智堂', author: '杨万里', lines: ['学子可怜生，', '远来参老子。', '仁智若为谈，', '指似秋山水。'] },
        ],
      },
      {
        targetName: '童趣', type: '提及',
        poems: [
          { title: '稚子弄冰', author: '杨万里', lines: ['稚子金盆脱晓冰，', '彩丝穿取当银钲。', '敲成玉磬穿林响，', '忽作玻璃碎地声。'] },
          { title: '舟过安仁', author: '杨万里', lines: ['一叶渔船两小童，', '收篙停棹坐船中。', '怪生无雨都张伞，', '不是遮头是使风。'] },
        ],
        extra: [
          { title: '闲居初夏午睡起 其二', author: '杨万里', lines: ['松阴一架半弓苔，', '偶欲看书又懒开。', '戏掬清泉洒蕉叶，', '儿童误认雨声来。'] },
        ],
      },
    ],
  },
  {
    ...
    relations: [
      ...
      {
        targetName: '范成大', type: '寄',
        poems: [
          { title: '除夜自石湖归苕溪十首 其一', author: '姜夔', lines: ['细草穿沙雪半销，', '吴宫烟冷水迢迢。', '梅花竹里无人见，', '一夜吹香过石桥。'] },
        ],
      },
    ],
  },
    ...
    relations: [
      {
        ...
        extra: [
          { title: '四时田园杂兴 其二', author: '范成大', lines: ['土膏欲动雨频催，', '万草千花一饷开。', '舍后荒畦犹绿秀，', '邻家鞭笋过墙来。'] },
        ],
      },
      {
        targetName: '横塘', type: '提及',
        poems: [
          { title: '横塘', author: '范成大', lines: ['南浦春来绿一川，', '石桥朱塔两依然。', '年年送客横塘路，', '细雨垂杨系画船。'] },
        ],
      },
      {
        targetName: '州桥', type: '提及',
        poems: [
  ...
  },
  {
    ...
    relations: [
      ...
      {
        targetName: '少年游', type: '提及',
        poems: [
          { title: '少年游·并刀如水', author: '周邦彦', lines: ['并刀如水，', '吴盐胜雪，', '纤手破新橙。', '锦幄初温，', '兽烟不断，', '相对坐调笙。', '低声问，', '向谁行宿，', '城上已三更。', '马滑霜浓，', '不如休去，', '直是少人行。'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relations: [
      ...
      {
        targetName: '博山', type: '提及',
        poems: [
          { title: '丑奴儿·书博山道中壁', author: '辛弃疾', lines: ['少年不识愁滋味，', '爱上层楼。', '爱上层楼，', '为赋新词强说愁。', '而今识尽愁滋味，', '欲说还休。', '欲说还休，', '却道天凉好个秋。'] },
        ],
      },
      {
        targetName: '郁孤台', type: '提及',
        poems: [
          { title: '菩萨蛮·书江西造口壁', author: '辛弃疾', lines: ['郁孤台下清江水，', '中间多少行人泪。', '西北望长安，', '可怜无数山。', '青山遮不住，', '毕竟东流去。', '江晚正愁余，', '山深闻鹧鸪。'] },
        ],
      },
      {
        targetName: '村居', type: '提及',
        poems: [
          { title: '清平乐·村居', author: '辛弃疾', lines: ['茅檐低小，', '溪上青青草。', '醉里吴音相媚好，', '白发谁家翁媪。', '大儿锄豆溪东，', '中儿正织鸡笼。', '最喜小儿亡赖，', '溪头卧剥莲蓬。'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relations: [
      ...
      {
        targetName: '西湖', type: '提及',
        poems: [
          { title: '采桑子·群芳过后西湖好', author: '欧阳修', lines: ['群芳过后西湖好，', '狼籍残红，', '飞絮蒙蒙，', '垂柳阑干尽日风。', '笙歌散尽游人去，', '始觉春空，', '垂下帘栊，', '双燕归来细雨中。'] },
        ],
      },
    ],
  },
    ...
    relations: [
      {
        ...
        extra: [
          { title: '水调歌头·徐州中秋', author: '苏辙', lines: ['离别一何久，', '七度过中秋。', '去年东武今夕，', '明月不胜愁。', '岂意彭城山下，', '同泛清河古汴，', '船上载凉州。', '鼓吹助清赏，', '鸿雁起汀洲。', '坐中客，', '翠羽帔，', '紫绮裘。', '素娥无赖，', '西去曾不为人留。', '今夜清尊对客，', '明夜孤帆水驿，', '依旧照离忧。', '但恐同王粲，', '相对永登楼。'] },
        ],
      },
      {
        targetName: '西湖', type: '提及',
  ...
  },
  {
    ...
    relations: [
      ...
      },
      {
        ...
        extra: [
          { title: '雨中登岳阳楼望君山二首 其二', author: '黄庭坚', lines: ['满川风雨独凭栏，', '绾结湘娥十二鬟。', '可惜不当湖水面，', '银山堆里看青山。'] },
          { title: '鄂州南楼书事 其一', author: '黄庭坚', lines: ['四顾山光接水光，', '凭栏十里芰荷香。', '清风明月无人管，', '并作南楼一味凉。'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relations: [
      {
        targetName: '嵩山', type: '提及',
        poems: [
          { title: '初见嵩山', author: '张耒', lines: ['年来鞍马困尘埃，', '赖有青山豁我怀。', '日暮北风吹雨去，', '数峰清瘦出云来。'] },
        ],
      },
      {
        targetName: '屈原', type: '提及',
        poems: [
          { title: '和端午', author: '张耒', lines: ['竞渡深悲千载冤，', '忠魂一去讵能还。', '国亡身殒今何有，', '只留离骚在世间。'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relations: [
      {
        targetName: '三子', type: '寄',
        poems: [
          { title: '示三子', author: '陈师道', lines: ['去远即相忘，', '归近不可忍。', '儿女已在眼，', '眉目略不省。', '喜极不得语，', '泪尽方一哂。', '了知不是梦，', '忽忽心未稳。'] },
        ],
      },
      {
        targetName: '读书', type: '提及',
        poems: [
          { title: '绝句·书当快意读易尽', author: '陈师道', lines: ['书当快意读易尽，', '客有可人期不来。', '世事相违每如此，', '好怀百岁几回开。'] },
        ],
      },
      {
        targetName: '邻里', type: '寄',
        poems: [
          { title: '春怀示邻里', author: '陈师道', lines: ['断墙着雨蜗成字，', '老屋无僧燕作家。', '剩欲出门追语笑，', '却嫌归鬓着尘沙。', '风翻蛛网开三面，', '雷动蜂窠趁两衙。', '屡失南邻春事约，', '只今容有未开花。'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relations: [
      {
        targetName: '望海楼', type: '提及',
        poems: [
          { title: '望海楼', author: '米芾', lines: ['云间铁瓮近青天，', '缥缈飞楼百尺连。', '三峡江声流笔底，', '六朝帆影落樽前。', '几番画角催红日，', '无事沧州起白烟。', '忽忆赏心何处是，', '春风秋月两茫然。'] },
        ],
      },
      {
        targetName: '垂虹亭', type: '提及',
        poems: [
          { title: '垂虹亭', author: '米芾', lines: ['断云一叶洞庭帆，', '玉破鲈鱼金破柑。', '好作新诗寄桑苎，', '垂虹秋色满东南。'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relations: [
      {
        targetName: '江村', type: '提及',
        poems: [
          { title: '江村晚眺', author: '戴复古', lines: ['江头落日照平沙，', '潮退渔船阁岸斜。', '白鸟一双临水立，', '见人惊起入芦花。'] },
        ],
      },
      {
        targetName: '江阴', type: '提及',
        poems: [
          { title: '江阴浮远堂', author: '戴复古', lines: ['横冈下瞰大江流，', '浮远堂前万里愁。', '最苦无山遮望眼，', '淮南极目尽神州。'] },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    relations: [
      ...
      {
        targetName: '惜别', type: '提及',
        poems: [
          { title: '唐多令·惜别', author: '吴文英', lines: ['何处合成愁，', '离人心上秋。', '纵芭蕉、不雨也飕飕。', '都道晚凉天气好，', '有明月、怕登楼。', '年事梦中休，', '花空烟水流。', '燕辞归、客尚淹留。', '垂柳不萦裙带住，', '漫长是、系行舟。'] },
        ],
      },
    ],
  },
  {
    ...
    relations: [
      {
        targetName: '听雨', type: '提及',
        poems: [
          { title: '虞美人·听雨', author: '蒋捷', lines: ['少年听雨歌楼上，', '红烛昏罗帐。', '壮年听雨客舟中，', '江阔云低、断雁叫西风。', '而今听雨僧庐下，', '鬓已星星也。', '悲欢离合总无情，', '一任阶前、点滴到天明。'] },
        ],
      },
      {
        targetName: '吴江', type: '提及',
        poems: [
          { title: '一剪梅·舟过吴江', author: '蒋捷', lines: ['一片春愁待酒浇，', '江上舟摇，', '楼上帘招。', '秋娘渡与泰娘桥，', '风又飘飘，', '雨又萧萧。', '何日归家洗客袍，', '银字笙调，', '心字香烧。', '流光容易把人抛，', '红了樱桃，', '绿了芭蕉。'] },
        ],
      },
    ],
  },
